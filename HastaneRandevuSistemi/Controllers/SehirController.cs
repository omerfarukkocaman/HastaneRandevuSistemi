...
namespace HastaneRandevuSistemi.Controllers
{
    public class SehirController : Controller
    {
        ...
        public SehirController(HastaneRandevuSistemiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Sehir != null ? 
                          ...
                          Problem("Entity set 'HastaneRandevuSistemiContext.Sehir'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SehirIsmi")] Sehir sehir)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SehirIsmi")] Sehir sehir)
        {
            if (id != sehir.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HastaneRandevuSistemiContext.Sehir'  is null.");
            }
            var sehir = await _context.Sehir.FindAsync(id);
            if (sehir != null)
            {
